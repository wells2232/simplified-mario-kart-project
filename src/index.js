const characters = [
    { NOME : "Mario", IMAGEM: "../docs/mario.gif", VELOCIDADE : 4, MANOBRABILIDADE : 3, PODER : 3, PONTOS : 0 },
    { NOME : "Luigi", IMAGEM: "../docs/luigi.gif", VELOCIDADE : 3, MANOBRABILIDADE : 4, PODER : 4, PONTOS : 0 },
    { NOME : "Yoshi", IMAGEM: "../docs/yoshi.gif", VELOCIDADE : 2, MANOBRABILIDADE : 4, PODER : 3, PONTOS : 0 },
    { NOME : "Peach", IMAGEM: "../docs/peach.gif", VELOCIDADE : 3, MANOBRABILIDADE : 4, PODER : 2, PONTOS : 0 },
    { NOME : "Bowser", IMAGEM: "../docs/bowser.gif", VELOCIDADE : 5, MANOBRABILIDADE : 2, PODER : 5, PONTOS : 0 },
    { NOME : "Donkey Kong", IMAGEM: "../docs/dk.gif", VELOCIDADE : 2, MANOBRABILIDADE : 2, PODER : 5, PONTOS : 0 }
];
